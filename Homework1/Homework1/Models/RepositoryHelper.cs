namespace Homework1.Models
{
	public static class RepositoryHelper
	{
		...
		public static SampleReportRepository GetSampleReportRepository()
		{
			var repository = new SampleReportRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static SampleReportRepository GetSampleReportRepository(IUnitOfWork unitOfWork)
		{
			var repository = new SampleReportRepository();
